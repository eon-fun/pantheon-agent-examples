...
from twitter_ambassador_utils.main import TwitterAuthClient, set_like
...
class TwitterLikerAgent(BaseAgent):
    ...
    async def set_likes(self, goal: str) -> bool:
        ...
        try:
            ...
            tweets_to_like = [tweet for tweet in tweets_dict.values() if tweet.id_str not in likes_tweet_before]
